                        ...
                        <div className="chat-card__info__message">
                            <div>
                                <div className="chat-card__info__message__author-and-content">
                                    {
                                        /* show the last message author if its a group */
                                        type==='group'?"~:"+messages[messages.length - 1].author.displayName+": ":''
                                    }
