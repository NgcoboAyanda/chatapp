...
import { ContactInterface } from "../../interfaces/data/dataInterfaces";
...
const ContactCard = ( { contact } : ContactCardProps ) => {
    ...
    return (
        <div className="contact-card">
            <div>
                <div className="contact-card__pic">
                    <div>
                        {renderContactPfp()}
                    </div>
                </div>
